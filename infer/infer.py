...
from deep_training.zoo.model_zoo.llm.llm_model import RotaryNtkScaledArguments,RotaryLinearScaledArguments # aigc-zoo 0.1.20
...
if __name__ == '__main__':
    ...
    if config_args['model_name_or_path'].lower().find('tiger') >=0:
